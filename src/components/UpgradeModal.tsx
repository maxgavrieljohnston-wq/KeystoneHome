  ...
  const tiers = [
    {
      ...
      monthly: 9,
      yearly: 86,
      features: ["Unlimited scenarios", "Invest vs. save projection", "Monthly Investment Plan PDF", "PDF & CSV export", "Tags, notes & goal", "Themed reports", "Shareable link & email reminders"],
    },
    {
      id: "pro" as const,
      name: "Pro",
